...
public:
  ...
  CPD(int order, int *size, int r, World &dw, double tol_restart_dt, bool use_msdt);
   ...
   */
  bool als(double tol, double Vnorm, double timelimit, int maxsweep,
           int resprint, ofstream &Plot_File, bool bench = false);
